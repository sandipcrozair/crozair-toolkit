...
import { getVacuumUnitIcon, FiRefreshCw } from "../../../utils/vacuumIcons";
      ...
      <div className="mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-2">
            Convert between vacuum and pressure units with precision. Change any
            value or any unit to alter another value.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm mb-6 sm:mb-8">
          <div className="p-4 sm:p-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <div className="flex-1 min-w-0">
                    <input
                      ...
                      className={`w-full px-3 py-2 text-sm sm:text-base border rounded-lg focus:outline-none focus:ring-1 transition-colors ${
                        lastChanged === "output"
                  ...
                  <div className="relative w-full sm:w-48 flex-shrink-0">
                    <select
                      ...
                      className={`w-full px-3 py-2 text-sm sm:text-base border rounded-lg focus:outline-none focus:ring-1 appearance-none pr-10 transition-colors bg-white ${
                        lastChanged === "output"
                          ? "border-green-500 ring-1 ring-green-200 bg-green-50"
                          : "border-gray-300 focus:ring-green-500 focus:border-green-500"
                      }`}
            ...
            <div className="flex flex-wrap justify-end gap-2 mt-4">
              {/* <button
                onClick={clearAll}
                className="px-3 py-1.5 text-sm bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-1"
                type="button"
              >
                Clear All
              </button> */}
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 sm:p-6 mb-4">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-600 mt-2 flex items-center justify-center gap-2">
                        All conversions from {inputValue} {inputUnit}
                        <span
                      ...
                      return (
                        <div
                          ...
                          className={`border-2 rounded-lg p-3 sm:p-4 transition-all duration-200 ${
                            ...
                            isRecentlyChanged
                              ? "ring-2 ring-opacity-70 shadow-md"
                              : ""
                          } ${
                            isRecentlyChanged && isInputUnit
                              ? "ring-blue-400"
                              : isRecentlyChanged && isOutputUnit
                              ? "ring-green-400"
                              : ""
                          }`}
                        >
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs uppercase font-mono truncate text-gray-500">
                                {unit}
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-700">Recently Changed</span>
                      </div>
                    </div>
                  </div>
                </div>
